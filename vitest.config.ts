  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'src/config/env.ts',
        // Exclude common components without tests
        'src/components/common/common-ui.component.tsx',
        'src/components/common/breadcrumb.component.tsx',
        'src/components/common/camera-test.tsx',
        'src/components/common/card.component.tsx',
        'src/components/common/checkbox.component.tsx',
        'src/components/common/chip.component.tsx',
        'src/components/common/contry-code-dropdown.component.tsx',
        'src/components/common/country-select.component.tsx',
        'src/components/common/custom-toast.component.tsx',
        'src/components/common/dashboard-card.component.tsx',
        'src/components/common/district-selector.component.tsx',
        'src/components/common/dropdown.component.tsx',
        'src/components/common/index.ts',
        'src/components/common/input-phone-number.component.tsx',
        'src/components/common/input.component.tsx',
        'src/components/common/loader.component.tsx',
        'src/components/common/radio.component.tsx',
        'src/components/common/recaptcha.component.tsx',
        'src/components/common/reusable-grid-table.component.tsx',
        'src/components/common/state-selector.component.tsx',
        'src/components/common/toggle.component.tsx',
        'src/components/common/tooltip.component.tsx',
        'src/components/common/video-card.component.tsx',
        'src/components/common/video-popup.component.tsx',
