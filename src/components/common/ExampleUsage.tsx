          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <Toggle
                variant="success"
                label="Success"
                checked={toggleStates.successVariant}
                onChange={() => handleToggleChange('successVariant')}
              />
              <Toggle
                variant="warning"
                label="Warning"
                checked={toggleStates.warningVariant}
                onChange={() => handleToggleChange('warningVariant')}
              />
              <Toggle
                variant="error"
                label="Error"
                checked={toggleStates.errorVariant}
                onChange={() => handleToggleChange('errorVariant')}
              />
            </div>
