...
// Mock the VerifyOtpComponent
vi.mock('../../../../modules/auth/verify-otp/verify-otp.component', () => ({
  default: vi.fn(() => <div data-testid="verify-otp-component">Verify OTP Component</div>),
}));
...
describe('VerifyOtpPage', () => {
  ...
  describe('Component Structure', () => {
    ...
    it('should render VerifyOtpComponent as children', () => {
      render(<VerifyOtpPage />);
      
      expect(screen.getByTestId('auth-children')).toBeInTheDocument();
      expect(screen.getByTestId('verify-otp-component')).toBeInTheDocument();
    });
  });
  ...
  describe('Component Integration', () => {
    it('should integrate AuthComponent and VerifyOtpComponent correctly', () => {
      render(<VerifyOtpPage />);
      
      // Verify AuthComponent is rendered
      expect(screen.getByTestId('auth-component')).toBeInTheDocument();
      
      // Verify VerifyOtpComponent is rendered as children
      expect(screen.getByTestId('verify-otp-component')).toBeInTheDocument();
      
      // Verify they are properly nested
      const authChildren = screen.getByTestId('auth-children');
      expect(authChildren).toContainElement(screen.getByTestId('verify-otp-component'));
    });
  });
  ...
  describe('Component Exports', () => {
    it('should export VerifyOtpPage as default', () => {
